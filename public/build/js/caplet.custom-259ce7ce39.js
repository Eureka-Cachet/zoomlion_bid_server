$(function() {
    ...
    //var dateInput = $('input[data-date-type="report"]');


    //dateInput.find('span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
	...
	function showLoading(panel){
		var overlay = $('<div class="load-overlay">' +
			'<div><div class="c1">' +
			'</div><div class="c2"></div><div class="c3"></div>' +
			'<div class="c4"></div></div><span>Loading...</span></div>');
	...
	function hideLoading(panel){
		...
		panel.find(overlay).fadeOut("slow",function(){ $(this).remove() });
	}
