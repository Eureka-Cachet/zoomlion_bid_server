...
new _vue2.default({
    ...
    methods: {
        ...
        scrollTop: function scrollTop($main) {
            $main.animate({
                scrollTop: 0
            }, 500);
    ...
    ready: function ready() {
        setTimeout(function () {
            _jquery2.default.notific8('Hi Guest ,Username : ' + '<strong>demo</strong> and Password: <strong>demo</strong> to  access account.', {
                sticky: true,
                horizontalEdge: "top",
                theme: "inverse",
                heading: "LOGIN ERROR"
...
},{"jquery":1,"vue":4,"vue-resource":3}]},{},[5]);
