<nav id="menu"  data-search="close" style="background: #29166f; color: white;">
    <ul>
        ...
        @if(collect([
            ...
            \Eureka\Helpers\Constants::OPERATION_ROLE])->contains(auth()->user()->roles->first()->id))
        ...
        @if(collect([\Eureka\Helpers\Constants::SYSADMIN_ROLE,
        ...
        @if(collect([\Eureka\Helpers\Constants::SYSADMIN_ROLE,
            \Eureka\Helpers\Constants::ADMIN_ROLE,
            \Eureka\Helpers\Constants::OPERATION_ROLE])->contains(auth()->user()->roles->first()->id))
        ...
        @if(collect([\Eureka\Helpers\Constants::SYSADMIN_ROLE,
            \Eureka\Helpers\Constants::ADMIN_ROLE,
            \Eureka\Helpers\Constants::OPERATION_ROLE,
            \Eureka\Helpers\Constants::ACCOUNT_ROLE,
            \Eureka\Helpers\Constants::AUDIT_ROLE])->contains(auth()->user()->roles->first()->id))
        ...
        @if(collect([\Eureka\Helpers\Constants::SYSADMIN_ROLE,
            \Eureka\Helpers\Constants::IT_ROLE])->contains(auth()->user()->roles->first()->id))
        ...
        @if(collect([\Eureka\Helpers\Constants::SYSADMIN_ROLE])->contains(auth()->user()->roles->first()->id))
